        ...
        children: [
            {
                ...
                description: `As a junior controller I translated complex financial data to include profit and sales reports so that it was easily understood by customers.
                Interpreted and organized large sets of data so that users could make financial decisions with accurate and timely information. I did cost analysis to determine the profitability of new products.
                `
            }, {
        ...
        children: [
            {
                ...
                description: `As a navy cadet I trained for two years to become a Navy officer at the Chilean Navy. At that time the officer's training was a 5 year program that begun with the last two years of high school and continued for three more. I myself did my last two years of high school in the program. I learned discipline, commitment, camaraderie, and much more. A large portion of who I am today can be traced back to these two years of my life.`
            }
        ]
    }
]
