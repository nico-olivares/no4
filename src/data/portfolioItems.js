...
const portfolioItems = [
    {
        ...
        stack: ['JavaScript', 'HTML', 'CSS'],
        github: `https://github.com/nico-olivares/p05-calculator`,
...
//returns an array with all the titles if the input is 'all items'. If the input is a single title it returns that item
function getPortfolioItem(name) {
    if (name === 'all items') {
        return portfolioItems.map(item => item.title);
    }
