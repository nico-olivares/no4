...
export default function MenuItem({ title, subtitle, activeMenu, setActiveMenu, setCenterPanelName, 
	setRightPanelName, rightPanelName, setPanelIsVisible, setExpandedMenu, isPhone }) {
	...
	const handleItemClick = (event, { name }) => {
		...
		if (isPhone) setExpandedMenu(false);
	}
